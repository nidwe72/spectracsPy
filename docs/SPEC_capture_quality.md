...
date it and each needs a regeneration, not a patch: ✅ the **448 trim** — LANDED 2026-08-10
(`SPEC_soret_448_trim.md`), so `M448` is no longer quoted "as if it ships", it ships; the **σ_fill run**
