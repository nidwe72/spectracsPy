...
Status: **S0 · S1a · S1b · S2 · S3a · S3b IMPLEMENTED (2026-07-16/17) — `spectracsPy-core` EXISTS and is Qt-free; S4–S5 DESIGN** (spec-first; implement on explicit request only). Source:
